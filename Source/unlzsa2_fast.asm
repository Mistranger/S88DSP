...
;  3. This notice may not be removed or altered from any source distribution.
    Relaxed        on    
    SECTION Lzsa2Unpack
    PUBLIC DecompressLZSA2
UNROLL_LONG_MATCHES equ 1						; uncomment for faster decompression of very compressible data (+38 bytes)
...
ReadToken:	ld a,(hl)
        and %00011000
        jp pe,Literals0011		; process the cases 00 and 11 separately
...
VeryLongMatch:	ld c,(hl)
        NEXT_HL
		ld b,(hl)
        NEXT_HL
        jr nz,LongMatch.useC
		pop de
        ret
